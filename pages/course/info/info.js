...
// const { openArticle } = require('../../../utils/course.js')
...
Page({
  ...
  rest: function () {
    // wx.navigateTo({
    //   url: '/pages/article/article?src=' + encodeURIComponent('http://jwgl.lnc.edu.cn/ZNPK/KBFB_ClassSel.aspx')
    // })
  },
  ...
  deleteCourse: function () {
    if (course.deleteCourse(this.data.course)) {
      app.msg('删除成功！')
      wx.navigateBack({
        delta: 1,
      })
